...
![Microsoft 365 PowerShell Automation Architecture](architecture.png)
...
![PowerShell User Creation](01-user-creation-powershell-redacted.png)

### 2. Bulk User Creation from CSV

![Bulk User Creation from CSV](02-bulk-user-creation-csv-redacted.png)

### 3. Groups Created with PowerShell

![Groups Created with PowerShell](03-groups-created-powershell-redacted.png)

### 4. Add User to Group with PowerShell

![Add User to Group with PowerShell](04-add-user-to-group-redacted.png)

### 5. Teams Created with PowerShell

![Teams Created with PowerShell](05-teams-created-powershell-redacted.png)

### 6. Teams Meeting Policy Created

![Teams Meeting Policy Created](06-teams-meeting-policy-redacted.png)

### 7. Shared Mailbox Created

![Shared Mailbox Created](07-shared-mailbox-created-redacted.png)

### 8. SharePoint Site Created

![SharePoint Site Created](08-sharepoint-site-created-redacted.png)

### 9. Teams Reporting with PowerShell

![Teams Reporting with PowerShell](09-teams-reporting-powershell-redacted.png)

### 10. Mailbox Reporting with PowerShell

![Mailbox Reporting with PowerShell](10-mailbox-reporting-powershell-redacted.png)

### 11. Microsoft 365 User Reporting with PowerShell

![Microsoft 365 User Reporting with PowerShell](11-m365-user-reporting-powershell-redacted.png)

### 12. SharePoint Site Reporting with PowerShell

![SharePoint Site Reporting with PowerShell](12-sharepoint-site-reporting-redacted.png)
